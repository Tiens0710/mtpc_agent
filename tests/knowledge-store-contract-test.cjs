...
assert(zalo.includes('Không tự giới thiệu lại') && zalo.includes('Không tự chèn số điện thoại'), 'Zalo prompt must avoid repetitive greetings and unsolicited contact details');
